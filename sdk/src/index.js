...
import rule from './rule'; //校验上报的数据是否合法的
...
const feeTarget = 'http://localhost/dig.gif'  //上报服务器   （目标）
...
const LOG_TYPE_PRODUCT = 'product' // 产品指标   （pv、uv、页面停留时间等 用户体验相关）
const LOG_TYPE_INFO = 'info' // 尚未使用
const LOG_TYPE_PERFORMANCE = 'perf' // 性能指标 （创建、启动、响应时间）
...
// 验证日志合法的 查看必要的字段是否有 pid error detail extra
